...
# Students
student_1 = Student('Имя_1', 'Фамилия_1', 'М')
student_1.courses_in_progress += ['Python']
student_1.finished_courses += ['Название курса']

student_2 = Student('Имя_2', 'Фамилия_2', 'Ж')
student_2.courses_in_progress += ['Python']
student_2.finished_courses += ['Название курса']

# Lecturers
lecturer_1 = Lecturer('Имя_3', 'Фамилия_3')
lecturer_1.courses_attached += ['Python']

lecturer_2 = Lecturer('Имя_4', 'Фамилия_4')
lecturer_2.courses_attached += ['Python']

# Reviewers
reviewer_1 = Reviewer('Имя_5', 'Фамилия_5')
reviewer_1.courses_attached += ['Python']

reviewer_2 = Reviewer('Имя_6', 'Фамилия_6')
...
def average_rating_for_course(course, student_list):
    ...
    for stud in student_list:
        for course in stud.grades:
            stud_sum_rating = stud.average_rating_for_course(course)
...
print(f'Средняя оценка за ДЗ: {average_rating_for_course("Python", student_list)}')
print(f'Средняя оценка за лекции: {average_rating_for_course("Python", lecturer_list)}')
print('–' * 50)
print(student_1)
print('–' * 50)
print(student_2)
